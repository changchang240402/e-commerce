<?php
    $host = 'database.crrgeosgu4h6.ap-southeast-1.rds.amazonaws.com:3306'; // El nombre del servicio de la base de datos en el archivo docker-compose.yml; // El puerto mapeado en el archivo docker-compose.yml
